    ...
    class ReportsDB {
        ...
        private string BuildParentReportQuery(string parentID, params string[] dates) {
            ...
            if (dates != null && dates.Length == 2) {
                ...
                query += "Last, EventDataT.EventName AS 'Event Type', time(ChildcareTransaction.CheckedIn) AS 'Check In', ";
                ...
                query += "NATURAL JOIN ChildcareTransaction NATURAL JOIN EventDataT WHERE AllowedConnections.Guardian_ID = '" + parentID + "' ";
